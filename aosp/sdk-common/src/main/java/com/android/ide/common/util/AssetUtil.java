...
//    }
    ...
    /**
     * Creates a new ARGB {@link Bitmap} of the given width and height.
     *
     * @param width  The width of the new image.
     * @param height The height of the new image.
     * @return The newly created image.
     */
    public static Bitmap newArgbBitmap(int width, int height) {
        return Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
    }

    /**
     * Smoothly scales the given {@link Bitmap} to the given width and height using the
     ...
     */
//    public static Bitmap scaledImage(Bitmap source, int width, int height) {
//        Image scaledImage = source.getScaledInstance(width, height, Image.SCALE_SMOOTH);
//        Bitmap scaledBufImage = new Bitmap(width, height,
...
//    }
    ...
    /**
     * Applies a gaussian blur of the given radius to the given {@link Bitmap} using a kernel
     * convolution.
     *
     * @param source The source image.
     ...
     */
//    public static Bitmap blurredImage(Bitmap source, double radius) {
//        if (radius == 0) {
//            return source;
//        }
//
...
//        Bitmap paddedSource = paddedImage(source, r);
//        Bitmap blurredPaddedImage = operatedImage(paddedSource, new ConvolveOp(
...
//    }
    ...
    /**
     * Inverts the alpha channel of the given {@link Bitmap}. RGB data for the inverted area
     ...
     */
//    public static Bitmap invertedAlphaImage(Bitmap source) {
...
//    }
    ...
    /**
     * Applies a {@link BitmapOp} on the given {@link Bitmap}.
     *
     * @param source The source image.
     * @param op     The operation to perform.
     * @return A new image with the operation performed.
     */
//    public static Bitmap operatedImage(Bitmap source, BitmapOp op) {
//        Bitmap newImage = newArgbBitmap(source.getWidth(), source.getHeight());
//        Canvas g = (Canvas) newImage.getGraphics();
//        g.drawImage(source, op, 0, 0);
//        return newImage;
//    }

    /**
     * Fills the given {@link Bitmap} with a {@link Paint}, preserving its alpha channel.
     *
     * @param source The source image.
     * @param paint  The paint to fill with.
     * @return A new, painted/filled image.
     */
//    public static Bitmap filledImage(Bitmap source, Paint paint) {
//        Bitmap newImage = newArgbBitmap(source.getWidth(), source.getHeight());
//        Canvas g = (Canvas) newImage.getGraphics();
...
//    }
    ...
    /**
     * Pads the given {@link Bitmap} on all sides by the given padding amount.
     *
     * @param source  The source image.
     ...
     */
//    public static Bitmap paddedImage(Bitmap source, int padding) {
//        if (padding == 0) {
//            return source;
//        }
//
//        Bitmap newImage = newArgbBitmap(
...
//    }
    ...
    /**
     * Trims the transparent pixels from the given {@link Bitmap} (returns a sub-image).
     *
     * @param source The source image.
     * @return A new, trimmed image, or the source image if no trim is performed.
     */
//    public static Bitmap trimmedImage(Bitmap source) {
...
//    }
    ...
    /**
     * Draws the given {@link Bitmap} to the canvas, at the given coordinates, with the given
     ...
     */
//    public static void drawEffects(Canvas g, Bitmap source, int x, int y,
//                                   Effect[] effects) {
...
//        final Rect imageRect = new Rect(0, 0, source.getWidth(), source.getHeight());
//        Bitmap out = newArgbBitmap(imageRect.width, imageRect.height);
//        Canvas g2 = (Canvas) out.getGraphics();
...
//            }
//
//            Bitmap innerShadowImage = newArgbBitmap(
//                    imageRect.width, imageRect.height);
//            Canvas g3 = (Canvas) innerShadowImage.getGraphics();
...
//    }
    ...
    /**
     * Draws the given {@link Bitmap} to the canvas, centered, wholly contained within the
     ...
     *                image.
     */
//    public static void drawCenterInside(Canvas g, Bitmap source, Rect dstRect) {
//        final int srcWidth = source.getWidth();
//        final int srcHeight = source.getHeight();
...
//    }
    ...
    /**
     * Draws the given {@link Bitmap} to the canvas, centered and cropped to fill the
     * bounds defined by the destination rectangle, and with preserved aspect ratio.
     *
     * @param g       The destination canvas.
     * @param source  The source image.
     ...
     *                image.
     */
//    public static void drawCenterCrop(Canvas g, Bitmap source, Rect dstRect) {
//        final int srcWidth = source.getWidth();
//        final int srcHeight = source.getHeight();
//        if (srcWidth * 1.0 / srcHeight > dstRect.width * 1.0 / dstRect.height) {
...
//    }
     ...
     * {@link AssetUtil#drawEffects(java.awt.Canvas, java.awt.image.Bitmap, int, int, AssetUtil.Effect[])}
     */
