...
public class MyKeyboardView extends View implements View.OnClickListener {
    ...
    public MyKeyboardView(Context context, AttributeSet attrs, int defStyle) {
        ...
        //TypedArray a = context.obtainStyledAttributes(attrs, android.R.attr.styleable.KeyboardView, defStyle, 0);
...
//        int n = a.getIndexCount();
        ...
        //SPartacus
//        mKeyBackground = getResources().getDrawable(R.drawable.btn_keyboard_key_ics);
        mVerticalCorrection = android.R.attr.verticalCorrection;
        previewLayout = 0;
        mPreviewOffset = 0;
        mPreviewHeight = 80;
        mKeyTextSize = 18;
        ...
        */
        ...
        mDisambiguateSwipe = true;//getResources().getBoolean(com.android.internal.R.bool.config_swipeDisambiguation);
...
//                mMiniKeyboard = (MyKeyboardView) mMiniKeyboardContainer.findViewById(com.android.internal.R.id.keyboardView);
