...
public class ASFormatter extends ASBeautifier {
    ...
    private void buildLanguageVectors() {
        ...
        nonParenHeaders = new ArrayList<>();
        assignmentOperators = new ArrayList<>();
        operators = new ArrayList<>();
        preDefinitionHeaders = new ArrayList<>();
        preCommandHeaders = new ArrayList<>();
        castOperators = new ArrayList<>();
    ...
    private void breakLine() {
        System.out.println("ASFormatter.breakLine");
    ...
    private void padOperators(String newOperator) {
        System.out.println("padOperators() called with: newOperator = [" + newOperator + "]");
