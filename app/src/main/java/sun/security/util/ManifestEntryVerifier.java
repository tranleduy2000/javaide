...
// import sun.security.jca.Providers; // out:kellinwood
...
//    private static final Provider digestProvider = Providers.getSunProvider(); // out:kellinwood
            ...
            if (key.toUpperCase(Locale.ENGLISH).endsWith("-DIGEST")) {
                ...
                if (digest == null) {
                    try {
                        ...
                        digest = MessageDigest.getInstance(algorithm /* out:kellinwood , digestProvider */);
