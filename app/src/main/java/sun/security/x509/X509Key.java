...
public class X509Key implements PublicKey {
    ...
    public static PublicKey parse(DerValue in) throws IOException
    {
        ...
        try {
        	...
        	// throw new IOException("subject key, " + e.getMessage(), e); // out:kellinwood
        	throw new IOException("subject key, " + e.getMessage()); // in:kellinwood
        }
