...
/**
 * Some objects that implement {@link android.text.TextDirectionHeuristic}. Use these with
 * the {@link android.text.BidiFormatter#unicodeWrap unicodeWrap()} methods in {@link android.text.BidiFormatter}.
