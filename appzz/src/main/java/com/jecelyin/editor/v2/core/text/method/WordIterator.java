 ...
 * {@link java.text.BreakIterator#getWordInstance()}, and caches {@link CharSequence}
...
//            mString = ((SpannableStringBuilder) charSequence).substring(mOffsetShift, windowEnd);
            mString = substring((SpannableStringBuilder) charSequence, mOffsetShift, windowEnd);
        } else {
    ...
    public String substring(SpannableStringBuilder spannableStringBuilder, int start, int end) {
        char[] buf = new char[end - start];
        spannableStringBuilder.getChars(start, end, buf, 0);
