...
//        super.reportFinish();
    ...
    /**
     * Calls the {@link android.widget.TextView#onCommitCorrection} method of the associated TextView.
     */
    @Override
...
//        mIMM.setUpdateCursorAnchorInfoMode(cursorUpdateMode);
        InputMethodManagerCompat.setUpdateCursorAnchorInfoMode(mIMM, cursorUpdateMode);
...
//            } else if (mTextView.isInLayout()) {
            } else if (ViewCompat.isInLayout(mTextView)) {
