...
import com.jecelyin.editor.v2.core.content.UndoOperation;
import com.jecelyin.editor.v2.core.content.UndoOwner;
...
import com.jecelyin.editor.v2.core.text.method.WordIterator;
import com.jecelyin.editor.v2.core.view.InputMethodManagerCompat;
import com.jecelyin.editor.v2.core.view.ViewConfigurationCompat;
...
//            hideControllers(); //选中文本后，需要CAB子菜单或主菜单进行一些操作
...
//                return false; // 双击时也应该弹出CAB
        ...
        if (!willExtract) {
            Callback actionModeCallback = new SelectionActionModeCallback();
...
//        }
    ...
    /**
     * @return <code>true</code> if the cursor/current selection overlaps a {@link android.text.style.SuggestionSpan}.
     */
    ...
    /**
     * @return <code>true</code> if the cursor is inside an {@link android.text.style.SuggestionSpan} with
     * {@link android.text.style.SuggestionSpan#FLAG_EASY_CORRECT} set.
     */
    ...
    void onTouchUpEvent(MotionEvent event) {
        ...
        if (mTextView.hasSelection()) //双击后有CAB时，不能再隐藏了
            hideControllers();
...
//            }
    ...
    private void updateCursorPosition(int cursorIndex, int top, int bottom, float horizontal) {
        if (mCursorDrawable[cursorIndex] == null)
            mCursorDrawable[cursorIndex] = mTextView.getContext().getResources().getDrawable(
    ...
    private boolean shouldBlink() {
        boolean cv = isCursorVisible();
        boolean focused = mTextView.isFocused();
        if (!cv || !focused) return false;
    ...
    private static class Blink extends Handler implements Runnable {
        ...
        public void run() {
            ...
            Editor editor = editorWeakReference.get();
            if (editor == null)
                return;

            if (editor.shouldBlink()) {
                if (editor.mTextView.getLayout() != null) {
                    editor.mTextView.invalidateCursorPath();
                }
...
//        shadowView.setTextAppearance(mTextView.getContext(), R.styleable.Theme_textAppearanceLarge);
    ...
    /**
     * Controls the {@link android.text.style.EasyEditSpan} monitoring when it is added, and when the related
     * pop-up should be displayed.
     * Also monitors {@link android.text.Selection} to call back to the attached input method.
     */
    ...
    /**
     * Displays the actions associated to an {@link android.text.style.EasyEditSpan}. The pop-up is controlled
...
//                R.layout.text_edit_action_popup_text;
...
//                    R.attr.textSelectHandleWindowStyle);
        ...
        protected void initContentView() {
            ...
            mContentView.setBackgroundResource(
                    R.drawable.text_edit_side_paste_window);
            ...
            mDeleteTextView = (android.widget.TextView) inflater.inflate(R.layout.text_edit_action_popup_text, null);
...
//                R.attr.textSuggestionsWindowStyle);
                0);
            mPopupWindow.setInputMethodMode(PopupWindow.INPUT_METHOD_NOT_NEEDED);
        ...
        private boolean updateSuggestions() {
            ...
            if (misspelledSpan != null) {
                ...
                if (misspelledStart >= 0 && misspelledEnd > misspelledStart) {
                    ...
                    suggestionInfo.text.replace(0, suggestionInfo.text.length(), mTextView.
                            getContext().getString(R.string.addToDictionary));
            ...
            suggestionInfo.text.replace(0, suggestionInfo.text.length(),
                    mTextView.getContext().getString(R.string.deleteText));
            suggestionInfo.text.setSpan(suggestionInfo.highlightSpan, 0, 0,
                    Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            mNumberOfSuggestions++;
...
//                    LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
//
//            mPasteTextView = (android.widget.TextView) inflater.inflate(R.layout.text_edit_action_popup_text, null);
//            mPasteTextView.setLayoutParams(wrapContent);
//            mContentView.addView(mPasteTextView);
//            mPasteTextView.setText(R.string.paste);
//            mPasteTextView.setOnClickListener(this);
//
//            mReplaceTextView = (android.widget.TextView) inflater.inflate(R.layout.text_edit_action_popup_text, null);
...
//                final Drawable handle = mTextView.getContext().getResources().getDrawable(
...
//    }
    ...
    /**
     * A listener to call {@link android.view.inputmethod.InputMethodManager#updateCursorAnchorInfo(android.view.View, android.view.inputmethod.CursorAnchorInfo)}
     * while the input method is requesting the cursor/anchor position. Does nothing as long as
     * {@link android.view.inputmethod.InputMethodManager#isWatchingCursor(android.view.View)} returns false.
     */
    ...
    private class InsertionPointCursorController implements CursorController {
        ...
        private InsertionHandleView getHandle() {
            if (mSelectHandleCenter == null) {
                mSelectHandleCenter = mTextView.getContext().getResources().getDrawable(
                        mTextView.mTextSelectHandleRes);
            }
            if (mHandle == null) {
...
//                        int doubleTapTouchSlop = viewConfiguration.getScaledDoubleTapTouchSlop();
                        int doubleTapTouchSlop = ViewConfigurationCompat.getScaledDoubleTapTouchSlop(viewConfiguration);
...
//    }
    ...
    public static class UndoInputFilter implements InputFilter {
        final WeakReference<Editor> mEditor;
        ...
        public CharSequence filter(CharSequence source, int start, int end,
            ...
            op = new TextModifyOperation(editor.mUndoOwner);
            op.mRangeStart = dstart;
            if (start < end) {
                op.mRangeEnd = dstart + (end-start);
            } else {
