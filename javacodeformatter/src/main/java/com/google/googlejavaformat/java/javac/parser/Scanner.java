...
import static com.google.googlejavaformat.java.javac.parser.Tokens.DUMMY;
import static com.google.googlejavaformat.java.javac.parser.Tokens.Token;
 ...
 */
public class Scanner implements com.google.googlejavaformat.java.javac.parser.Lexer {
     ...
     */
    protected Scanner(com.google.googlejavaformat.java.javac.parser.ScannerFactory fac, CharBuffer buf) {
        this(fac, new JavaTokenizer(fac, buf));
    }

    protected Scanner(com.google.googlejavaformat.java.javac.parser.ScannerFactory fac, char[] buf, int inputLength) {
