...
class VdNodeRender {
        ...
        for (int k = 0; k < val.length; k += incr) {
            ...
            switch (cmd) {
                ...
                case 'V':
                    ...
                    break;
                case 'c':
                    path.addArc(new RectF(cx + val[k + 0], cy + val[k + 1], cx + val[k + 2],
                    ...
                    break;
                case 'C':
                    path.addArc(new RectF(val[k + 0], val[k + 1], val[k + 2], val[k + 3]),
                            val[k + 4], val[k + 5]);
                    cx = val[k + 4];
                    cy = val[k + 5];
                    cpx = val[k + 2];
                ...
                case 's':
                    ...
                    path.addArc(new RectF(reflectCtrl ? 2 * cx - cpx : cx, reflectCtrl ? 2
    ...
    private static void arcToBezier(Path p, double cx, double cy, double a,
        ...
        for (int i = 0; i < numSegments; i++) {
            ...
            p.addArc(new RectF((float) q1x, (float) q1y, (float) q2x, (float) q2y),
                    (float) e2x, (float) e2y);
            eta1 = eta2;
            e1x = e2x;
            e1y = e2y;
