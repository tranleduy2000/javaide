...
public class PreValidator {
     ...
     * <ul>
     *     <li>{@link MergingReport.Result#SUCCESS} : the merging model is
     *     correct, merging should be attempted</li>
     *     <li>{@link MergingReport.Result#WARNING} : the merging model
     *     contains non fatal error, user should be notified, merging can be attempted</li>
     *     <li>{@link MergingReport.Result#ERROR} : the merging model
