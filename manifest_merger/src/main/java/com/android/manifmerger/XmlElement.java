...
public class XmlElement extends OrphanXmlElement {
    ...
    /**
     * Returns the {@link XmlAttribute} for an attribute present on this
     * xml element, or {@link Optional#absent} if not present.
     ...
     * {@link NodeOperationType#MERGE} will be returned.
     */
     ...
     * <p>
     * <ul>
     *     <li>The associate {@link ManifestModel.NodeTypes} is
